...
class _Sc10PaymentMethodState extends State<Sc10PaymentMethod> {
  final List<ItemCreditCards> _itemCreditCards = [
    ItemCreditCards(
        id: "**** **** **** 2779", path: SvgPicture.asset(PathAsset.IG_VISA)),
    ItemCreditCards(
        id: "adaff_hs@gmail.com", path: SvgPicture.asset(PathAsset.IG_PAYPAL)),
    ItemCreditCards(
        id: "**** **** **** 1334",
        path: SvgPicture.asset(PathAsset.IG_MASTERCARD))
  ];
  @override
